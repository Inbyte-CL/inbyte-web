...
export const testimonialData: TestimonialItem[] = [
	{
     ...
     invites, Cosmic Themes is a no-brainer for anyone launching a new Astro project. Now this testimonials is
     expanded to make this look better for demonstration purposes.
      `,
	},
	...
	},
	{
      ...
      I can't recommend enough Cosmic Themes. Now this testimonials is expanded to showcase the UI for demonstration purposes.
      In this section it is helpful to have some longer items and some shorter to diversify the card lengths and make it more catchy
      to the eye. Lorem ipsum sit amet consectetur adipisicing elit. 
      `,
	},
	{
		avatar: David,
